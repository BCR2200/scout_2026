    ...
    scoutItem = dataList
        .map(
          (e) => ScoutModel(
            ...
            start_position: e['start_position'] as int,
            auto_moved: e['auto_moved'] as int,
            auto_climb_level: e['auto_climb_level'] as int,
            auto_climb_position: e['auto_climb_position'] as int,
            teleop_climb_level: e['teleop_climb_level'] as int,
            teleop_climb_position: e['teleop_climb_position'] as int,
            auto_volleys: e['auto_volleys'] as String,
            teleop_volleys: e['teleop_volleys'] as String,
